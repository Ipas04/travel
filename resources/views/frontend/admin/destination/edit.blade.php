...
<div class="d-flex justify-center align-items-center">
    <div class="container">
        <h1 class="my-5">Edit Destinasi</h1>
            ...
            <div class="row mb-4">
                <div class="col-lg-6">
                    <div class=form-group>
                        ...
                        <input type="text" class="form-control" name="nama" value="{{ $destination->nama }}" required/>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="harga" class="form-control" value="{{ $destination->harga }}" required/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-lg-12">
                    <div class=form-group>
                        ...
                        <textarea type="text" name="deskripsi" class="form-control" required>{{ $destination->deskripsi }}</textarea>
                    </div>
                </div>
            </div>
